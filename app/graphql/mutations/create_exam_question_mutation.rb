module Mutations
  class CreateExamQuestionMutation < BaseMutation
    null true
    ...
    def resolve(question_text:, single_answer:, difficulty:, certification_exam_id:)
      context = CreateExamQuestion.call(certification_exam_id: certification_exam_id,
