module Mutations
  class UpdateExamQuestionResponseMutation < BaseMutation
    null true
    ...
    def resolve(id:, response_text:, explanation_text:, correct:, exam_question_id:)
      context = UpdateExamQuestionResponse.call(id: id,
